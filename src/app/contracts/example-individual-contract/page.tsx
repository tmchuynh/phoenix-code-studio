  ...
  return (
    <main className="w-10/12 md:w-9/12 mx-auto py-10">
      ...
      <section className="mb-10 space-y-6">
        <p>
          <strong>[Company Name] (Client):</strong> A [State/Country]
          corporation with its principal place of business at . . . . . . . . .
          . . . . . . . . . . . . . . . . .
        </p>
        <p>
          <strong>[Contractor's Full Name] (Contractor):</strong> An individual
      ...
      <section className="space-y-10">
        <div>
          ...
          <p>
            1.2 All services shall be performed in a professional and
        ...
        <div>
          ...
          <p>
            5.1 The Contractor agrees to keep all confidential information
            received from the Client strictly confidential.
          </p>
          <p>
      ...
      <section className="mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8">
          ...
          <div className="border border-muted p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-2">
              [Contractor's Full Name] (Contractor)
            </h3>
            <p className="text-sm mb-6">
              Signature: . . . . . . . . . . . . . . . . . . . . . . . . .{" "}
            </p>

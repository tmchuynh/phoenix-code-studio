    ...
    <main className="w-11/12 mx-auto py-6">
      ...
      <section className="my-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <span className="font-bold text-tertiary">Project Scope:</span>{" "}
            Detailed description of the project, including deliverables and
            timelines.
          </li>
          <li>
            <span className="font-bold text-tertiary">Payment Terms:</span>{" "}
          ...
          <li>
            <span className="font-bold text-tertiary">Project Timeline:</span>{" "}
            An agreed-upon timeline with key milestones and client feedback.
          </li>
          <li>
            <span className="font-bold text-tertiary">Termination Clause:</span>{" "}
      ...
      <section className="my-8">
        ...
        <p className="my-4">
          This contract is for an individual hiring **Phoenix Code Studio** for
          a project. It is tailored for smaller, more flexible engagements:
        </p>
        <ul className="list-disc list-inside space-y-2">
          <li>
            <span className="font-bold text-tertiary">Project Scope:</span> A
          ...
          <li>
            <span className="font-bold text-tertiary">Timeline:</span> Expected

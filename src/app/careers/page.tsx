...
const JobListingsPage: FC = () => {
  ...
  return (
    <>
      <RootLayout
        title="Careers at Phoenix Code Studio - Phoenix Code Studio"
        description="Explore diverse career opportunities at Phoenix Code Studio, including remote work and flexible schedules for various positions."
      >

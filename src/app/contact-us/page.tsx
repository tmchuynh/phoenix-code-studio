...
const ContactUsPage: FC = () => {
  ...
  return (
    <>
      <RootLayout
        title="Contact Us - Phoenix Code Studio"
        description="Get in touch with Phoenix Code Studio to discuss your digital needs. Whether you're looking for a custom website, brand revitalization, or digital marketing strategies, we're here to help your business grow and succeed online."
      >

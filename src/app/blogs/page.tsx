              ...
              {currentArticles.map((blog, index) => (
                ...
                >
                  <div>
                    ...
                    />
                    <div className="px-4 pb-2 flex flex-col justify-between h-[27em] md:h-[30em] lg:h-[40em] 2xl:h-[32em] relative">
                      <div>
                        <p>
                          <Button
                            variant="ghost"
                            className="text-primary underline underline-offset-2 px-0 lg:mt-5 lg:mb-2 font-SofiaSans tracking-wider font-bold hover:bg-transparent hover:text-primary hover:no-underline text-wrap text-left text-md md:text-lg 2xl:text-2xl"
                            onClick={() => {
                        ...
                        <p className="md:py-4">{blog.excerpt}</p>
                      </div>

                      {isSmallDevice ? null : isLargerScreen ? (
                        <div className="mt-4 flex flex-col bottom-6 absolute">

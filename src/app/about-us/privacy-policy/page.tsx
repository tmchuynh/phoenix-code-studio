   ...
   return (
     <div className="relative mx-auto sm:pt-5 w-11/12">
       ...
       <p>
         ...
         explains how we collect, use, and safeguard your data in accordance
         with applicable regulations including GDPR, CCPA, and other privacy
         laws.
       </p>
       ...
       <section id="information-collection" className="mb-8">
         ...
         <p className="mb-4">
           ...
           to our newsletter, or interact with our platform. We also collect
         ...
         <ul role="list" className="space-y-2 mb-6 pl-6 list-disc list-outside">
           ...
           <li>
             ...
             development needs, requirements, and specifications
           </li>
           <li>
       ...
       <section id="how-we-use" className="mb-8">
         ...
         <ul role="list" className="space-y-2 mb-6 pl-6 list-disc list-outside">
           <li>
             Provide and deliver our web development and software services
           </li>
       ...
       <section id="data-sharing" className="mb-8">
         ...
         <p className="mb-6">
           ...
           the same privacy protections outlined in this policy.
         </p>
       </section>
       ...
       <section id="data-security" className="mb-8">
         ...
         internet is 100% secure. We continuously monitor and update our
         security practices to maintain the highest level of protection for your
         data.
       </section>
       ...
       <section id="data-retention" className="mb-8">
         ...
         <p className="mb-4">
           ...
           by law. Our retention periods vary based on the type of information:
         </p>
       ...
       <section id="your-rights" className="mb-8">
         ...
         <p className="mb-6">
           ...
           directly. This will not affect our ability to send service-related
           communications.
         </p>
       ...
       <section id="cookies" className="mb-8">
         ...
         <p className="mb-6">
           ...
           browsers allow you to refuse cookies, delete existing cookies, and

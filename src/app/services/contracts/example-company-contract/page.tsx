  ...
  return (
    <main className="w-10/12 md:w-11/12 mx-auto py-6">
      ...
      <section className="mb-10 space-y-6">
        <p>
          <EmphasizeText>Company A </EmphasizeText> <strong>(Client):</strong>A
          corporation registered in
          <EmphasizeText> [State/Country] </EmphasizeText> with its principal
          place of business at
          <EmphasizeText> [Company Address] </EmphasizeText>. The Client engages
          the Contractor to provide services as outlined in this Agreement.
        </p>

        <p>
          <EmphasizeText>Company B </EmphasizeText>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              balance or $2,500, whichever is greater.
            </li>
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  within 30 days of written notice of the dispute. If

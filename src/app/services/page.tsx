    ...
    <main className="w-10/12 md:w-11/12 mx-auto py-6">
      ...
      <section className="my-16">
        ...
        <p>
          ...
          sizes grow and thrive in today’s competitive market. Whether you’re
          looking to enhance your online presence, streamline operations, or
          improve user experiences, we provide tailored solutions that align
          with your goals. From custom web development and e-commerce platforms
          to UX design and marketing strategies, our team of experts works with
          you every step of the way to ensure your business achieves its full
          potential.
        </p>
      ...
      <section className="my-16">
        ...
        <p>
          Our Website Services are designed to provide comprehensive solutions
          for businesses looking to establish a powerful online presence.
          Whether you need a custom website design, seamless development, or
          robust functionality, our team delivers tailored services to meet your
          unique needs. From responsive designs to e-commerce integrations, we
          ensure your website not only looks great but also performs optimally
      ...
      <section className="my-16">
        ...
        <p>
          Our Content Creation Services are designed to help your brand stand

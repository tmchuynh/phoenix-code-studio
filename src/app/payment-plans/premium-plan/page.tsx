      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-lg mb-4">
            ...
            project is executed efficiently and meets your long-term goals. With
            a focus on sustained quality and performance, the Premium Plan
            provides the flexibility and resources needed to bring ambitious
            projects to life.
          </p>
          ...
          <div className="mb-6">
            ...
            <p className="text-lg">
              ...
              payment structure, making it easier to manage expenses for
              long-term projects. This approach ensures that you have access to
              consistent service and support throughout the duration of your
              project. By spreading payments evenly over time, you can focus on
              achieving your goals without worrying about upfront financial
              burdens. This flexible arrangement allows for seamless
              collaboration and uninterrupted progress.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-lg">
              For larger and more complex projects, the Premium Plan provides
              the option to extend payment terms up to 12 months. This
              flexibility helps you better manage your budget and cash flow,
              ensuring that your project remains financially sustainable. With
              the ability to spread payments over an extended period, you can
              invest in the resources and expertise needed to bring your vision
              to life without compromising on quality or timelines.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-lg">
              ...
              introducing improvements as your needs evolve. Whether it’s
              regular maintenance, troubleshooting, or adapting your project to
              meet changing demands, we’re here to help every step of the way.
              With this level of continuous care, you can rest assured that your

      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <p className="text-lg">
              We understand that every project is unique, which is why our
              payment terms are tailored to match the size, complexity, and
              scope of your initiative. Whether you're working on a
              straightforward project or a large-scale, multi-phase endeavor, we
              can customize the payment structure to suit your financial
              planning. This flexibility ensures that you can move forward with
              confidence, knowing your budget and project requirements are
              perfectly aligned.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-lg">
              ...
              offering options for ongoing support and scalability. As your
              needs evolve, we provide post-launch maintenance, feature updates,
              and scaling solutions to keep your project relevant and effective.
              Whether you need continuous monitoring, new integrations, or
              expansions, we ensure your project adapts to meet changing
              demands, allowing for seamless growth without interruptions.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-lg">
              ...
              This allows you to spread out costs over an extended period,
              making it easier to manage your budget while still achieving
              timely project completion. With this extended term, you can focus
              on delivering impactful results without financial strain, ensuring
              that your project receives the attention and resources it deserves
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  business, including responsive design, e-commerce
                ...
                <li>
                  ...
                  months to accommodate budget flexibility.
                </li>
                <li>
                  <strong className="text-accent-3">Support:</strong> 6 months
                  of ongoing support after launch, covering regular updates, bug
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong className="text-accent-3">Payment Term:</strong>{" "}
                  $50,000 total project cost, divided into 5 installments over
                  18 months to support financial flexibility for a long-term
                  project.
                </li>
                <li>
                  <strong className="text-accent-3">Support:</strong>{" "}
                  Comprehensive support package after delivery, including
                  regular updates, scalability options, and new feature
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong className="text-accent-3">Project Scope:</strong>{" "}
                  Integration of advanced enterprise software into the existing
                  IT infrastructure, including data migration, workflow
                  automation, and security enhancements.
                </li>
                <li>
                  <strong className="text-accent-3">Payment Term:</strong>{" "}
                  $100,000 total project cost, divided into 6 installments over
                  24 months to provide extended payment flexibility for a
                  high-value project.
                </li>
                <li>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong className="text-accent-3">Project Scope:</strong>{" "}
                  Design and development of a scalable e-commerce platform with
                  features such as a product catalog, secure payment
                  integration, and personalized user experiences.
                </li>
                <li>
                  <strong className="text-accent-3">Payment Term:</strong>{" "}
                  $25,000 total project cost, split into 5 installments over 10
                  months for greater financial flexibility.
                </li>
                <li>
                  <strong className="text-accent-3">Support:</strong> 8 months
                  of post-launch support, including performance monitoring, bug
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong className="text-accent-3">Payment Term:</strong>{" "}
                  $75,000 total project cost, distributed over 8 installments
                  across 20 months to accommodate the phased delivery of the
                  platform.
                </li>
                <li>
                  <strong className="text-accent-3">Support:</strong> 12 months
                  of continuous support, including system updates, scalability
                  enhancements, and troubleshooting.
                </li>
                <li>
                  <strong className="text-accent-3">Additional Details:</strong>{" "}
                  An initial payment of $15,000, followed by 7 equal
                  installments of $8,500 every 3 months.
                </li>
              </ul>
            </div>
          </div>

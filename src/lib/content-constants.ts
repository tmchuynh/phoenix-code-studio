...
export const seoOptimizationBenefits = [
  {
    title: "Emotional Connection",
    description:
      "Stories evoke emotions, building trust and loyalty with your audience.",
  },
  {
    title: "Clarity and Purpose",
    description: "Clearly communicate your mission, vision, and values.",
...
export const seoOptimizationServices = [
  {
    title: "On-Page SEO",
    description:
      "Optimize website elements such as titles, meta descriptions, headings, and content for search engines.",
  },
  {
    title: "Off-Page SEO",
    description:
      "Improve your website's authority by building high-quality backlinks from reputable sources.",
  },
  {
    title: "Technical SEO",
    description:
      "Optimize the technical aspects of your website, such as loading speed, mobile-friendliness, and crawlability.",
  },
  {
    title: "Local SEO",
    description:
      "Optimize for location-based searches to improve visibility in local search results.",
  },
  {
    title: "Content Optimization",
    description:
      "Ensure that the content on your site is high-quality, relevant, and keyword-optimized.",
  },
];

export const processStepsSEO = [
  {
    title: "SEO Audit",
    description:
      "We start by performing a comprehensive SEO audit to identify areas for improvement on your website.",
  },
  {
    title: "Keyword Research",
    description:
      "Conduct thorough research to identify the most valuable and relevant keywords for your business.",
  },
  {
    title: "On-Page Optimization",
    description:
      "Optimize your website's content, meta tags, images, and internal linking to ensure that it’s aligned with SEO best practices.",
  },
  {
    title: "Off-Page SEO & Link Building",
    description:
      "Develop a strategy for acquiring high-quality backlinks and improving domain authority.",
  },
  {
    title: "Technical SEO Improvements",
    description:
      "Ensure that your website is technically sound, improving loading speeds, mobile responsiveness, and more.",
  },
  {
    title: "Content Strategy & Creation",
    description:
      "Create SEO-optimized content such as blogs, articles, and landing pages to engage users and drive traffic.",
  },
  {
    title: "Performance Tracking & Reporting",
    description:
      "We regularly monitor your website’s performance, providing detailed reports and making necessary adjustments.",
  },
];

export const toolsUsedSEO = [
  "Google Analytics for website traffic analysis",
  "Google Search Console for monitoring and maintaining SEO performance",
  "SEMrush for keyword research and competitive analysis",
  "Ahrefs for backlink analysis and research",
  "Moz for page optimization insights",
  "Yoast SEO for content optimization (WordPress)",
];

export const pricingTiersSEO = [
  {
    name: "Basic SEO Package",
    info:
      "Includes on-page SEO, keyword research, and basic reporting. Suitable for small websites or startups.",
  },
  {
    name: "Advanced SEO Package",
    info:
      "Includes on-page SEO, off-page SEO, technical SEO, and advanced keyword targeting. Ideal for growing businesses.",
  },
  {
    name: "Premium SEO Package",
    info:
      "Full-service SEO with on-page, off-page, technical SEO, local SEO, content creation, and ongoing optimization. Designed for large websites and enterprises.",
  },
];

export const uxDesignBenefits = [
  {
    title: "Improved Usability",
    description: "Simplify navigation and interactions for users.",
  },
  {
    title: "Enhanced Satisfaction",
    description: "Boost user engagement by solving real problems effectively.",
  },
  {
    title: "Higher Conversion Rates",
    description: "Optimize your product to guide users toward desired actions.",
  },
  {
    title: "Reduced Churn",
    description: "Create experiences that keep users coming back.",
  },
  {
    title: "Accessibility-First Approach",
    description: "Ensure inclusivity for users of all abilities.",
  },
];
...
export const uxDesignServices = [
  {
    title: "User Research",
    description:
      "Conducting interviews, surveys, and usability testing to understand user needs and behaviors.",
  },
  {
    title: "Journey Mapping",
    description: "Visualizing user workflows and identifying pain points.",
  },
  {
    title: "Wireframing & Prototyping",
    description:
      "Crafting low and high-fidelity designs to test and iterate on concepts.",
  },
  {
...
export const uxDesignProcess = [
  {
    title: "Discovery",
    description:
      "Understanding your goals, audience, and challenges through research and analysis.",
  },
  {
    title: "User Research",
    description: "Gathering insights from users to guide design decisions.",
  },
  {
    title: "Ideation",
    description:
      "Brainstorming solutions and creating user flows, wireframes, and prototypes.",
  },
  {
    title: "Testing & Validation",
    description:
      "Conducting usability testing to validate assumptions and refine designs.",
  },
  {
    title: "Delivery",
    description:
      "Providing finalized designs with detailed documentation for development teams.",
  },
  {
    title: "Iteration & Support",
    description:
      "Continuously improving the user experience based on feedback and evolving needs.",
  },
];

export const uxDesignTools = [
  "Figma for wireframes and prototyping",
  "Adobe XD for high-fidelity designs",
  "InVision for interactive prototypes and collaboration",
  "Maze for usability testing and user feedback",
  "Optimal Workshop for information architecture and card sorting",
  "Hotjar for tracking user behavior and engagement",
];

export const uxDesignPricingTiers = [
  {
    name: "Basic UX Design Package",
    info:
      "Includes user research, wireframing, and basic usability testing. Ideal for small projects.",
  },
  {
    name: "Advanced UX Design Package",
    info:
      "Adds in-depth journey mapping, prototyping, and extensive usability testing. Suitable for medium-scale projects.",
  },
  {
    name: "Premium UX Design Package",
    info:
      "Full-service UX design with comprehensive research, advanced prototyping, and continuous support. Designed for large, complex projects.",
  },
];

export const wireframingPrototypingBenefits = [
  {
    title: "Clarity",
    description: "Define layouts, content hierarchy, and navigation structure clearly.",
  },
  {
    title: "Cost-Effective Iterations",
    description: "Identify and fix issues early, saving time and resources.",
  },
  {
    title: "Collaboration",
    description: "Enable better communication between stakeholders, designers, and developers.",
  },
  {
    title: "User-Centered Design",
    description: "Test designs with users to validate assumptions and improve functionality.",
  },
  {
    title: "Accelerated Development",
    description: "Provide a clear blueprint for developers to build upon.",
  },
];

export const wireframingPrototypingServices = [
  {
    title: "Low-Fidelity Wireframes",
    description: "Quick sketches to outline content layout and navigation.",
  },
  {
    title: "High-Fidelity Wireframes",
    description: "Detailed wireframes with precise design elements for a closer representation of the final product.",
  },
  {
    title: "Interactive Prototypes",
    description: "Clickable prototypes that simulate real user interactions.",
  },
  {
    title: "Usability Testing Prototypes",
    description: "Prototypes optimized for testing with users to gather actionable feedback.",
  },
  {
    title: "Hand-Off Ready Designs",
    description: "Wireframes and prototypes complete with annotations for developers.",
  },
];

export const wireframingPrototypingProcess = [
  {
    title: "Discovery",
    description: "Gather requirements, understand user needs, and define project goals.",
  },
  {
    title: "Sketching",
    description: "Create rough wireframes to visualize ideas and structure.",
  },
  {
    title: "Wireframing",
    description: "Build detailed wireframes to establish layouts and content placement.",
  },
  {
    title: "Prototyping",
    description: "Develop interactive prototypes to simulate user interactions and workflows.",
  },
  {
    title: "Testing",
    description: "Conduct usability testing to validate the design and gather feedback.",
  },
  {
    title: "Iteration",
    description: "Refine designs based on insights from testing and feedback.",
  },
];

export const wireframingPrototypingTools = [
  "Figma for collaborative wireframing and prototyping",
  "Adobe XD for high-fidelity design and interactive prototypes",
  "Sketch for vector-based design and interface development",
  "InVision for creating interactive prototypes and real-time collaboration",
  "Axure RP for detailed, functional wireframes and prototypes",
  "Framer for advanced animations and interactive UI components",
];

export const wireframingPrototypingPricingTiers = [
  {
    name: "Basic Wireframing Package",
    info: "Includes low-fidelity wireframes and basic prototyping. Suitable for small projects.",
  },
  {
    name: "Advanced Prototyping Package",
    info: "Adds high-fidelity wireframes and interactive prototypes. Ideal for medium-scale projects.",
  },
  {
    name: "Premium UX/UI Package",
    info: "Full-service wireframing, prototyping, and usability testing. Designed for large, complex projects.",
  },
];

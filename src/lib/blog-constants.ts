...
export const contactlessCardOptions = [
  {
    ...
    productOptions: [
      ...
      "Professional, Business or Enterprise plans"
    ],
    analytics:
  ...
  },
  {
    ...
    productOptions: [
      "Classic, Wood, and Metal card designs",
      "NFC Key fob",
      "NFC smart button"
    ],
  },

  {
    ...
    productOptions: [
      "dot.card - a premium matte finish that is both weighty and soft-to-touch",
      "dot.band - crafted from a premium silicone",
      "dot.wallet - a sleek and minimalist card holder designed by dot. for the modern minimalist",
      "dot.thin (Ultra-Thin NFC Tag for Discreet Placement)",
      "dot.metal - a full metal bezel and a robust, solid feel",
      "dot.classic - can be placed on any surface imaginable",
      "dot.thin 2.0 - square shaped and fits beneath your phone case",
      "dot.thin 1.0 - circle shaped and fits beneath your phone case",
      "Customized dot Cards - For a limited time, there is a free custom mockup service that allows you to visualize your unique design before placing an order.",
    ],
    analytics:
  ...
  },
  {
    ...
    productOptions: [
      "Hyper Linq Card - Custom",
      "Hyper Linq Card",
      "Linq Card - Fully Custom",
      "Linq Card - Custom Logo",
      "Hyper Linq Card Metal - Laser Engraved",
      "Linq Card Metal - Laser Engraved",
      "Hyper Linq Card Metal",
      "Linq Card Metal",
      "Linq Card",
      "Linq Card - Bamboo",
      "MOO Business Cards - Powered by Linq",
      "Linq Band V2 for Apple Watch",
      "Hyper Linq Hub - Custom",
      "Hyper Linq Hub",
      "Linq Hub V2 - Custom",
      "Linq Hub V2",
      "Linq Tag",
      "Hyper Linq Hub Mini - Custom",
      "Linq Hub Mini V2 - Custom",
      "Linq Hub Mini V2",
      "Hyper Linq Badge - Custom",
      "Hyper Linq Badge",
      "Linq Badge - Custom",
      "Linq Badge",
      "Hyper Linq Tap XL Custom",
      "Hyper Linq Tap XL",
      "Linq Tap XL - Custom",
      "Linq Tap XL",
      "Linq Tap V2 - Custom",
    ...
    analytics:
      "Real-time analytics based on the results that matter most: shares, clicks, meetings scheduled, and more",
  },
  {
    name: "popl Cards",
    description:
    ...
    productOptions: [
      ...
      "Popl Card Eco",
      "Metal Popl Card",
      "Custom Metal Card (Laser Engraved)",
      "Popl Rope Band",
      "Custom Badge",
      "Popl Badge",
      "Popl Keychain",
  ...
  },
  {
    ...
    productOptions: [
      "Plastic Digital Business Card",
      "Aluminum Metal Digital Business Card",
      "Stainless Steel Digital Business Card",
      "Retrev Hub",
    ],
    analytics:
  ...
  },
  {
    ...
    analytics:
      "Track and analyze activity to gain insights and improve your message. Built-in reminders and follow-up tools make it easy to maintain meaningful connections.",
  },
];

...
const badgeVariants = cva(
  "inline-flex items-center px-4 py-1 border rounded-full focus:ring-2 focus:ring-ring focus:ring-offset-2 font-semibold text-xs transition-colors focus:outline-none",
  {
    variants: {
      variant: {
        default:
